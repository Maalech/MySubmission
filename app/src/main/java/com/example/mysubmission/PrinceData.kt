...
object PrinceData {
    ...
    private val princeDetails = arrayOf("Azura is the Daedric Prince whose sphere is dusk and dawn. Azura is always depicted as a female and is also known as \"Mother of the Rose,\" \"Queen of the Night Sky,\" and the Anticipation of Sotha Sil. Her artifact is Azura's Star.",
        ...
        "Hircine is the Daedric Prince whose sphere is the Hunt, the Sport of Daedra, the Great Game, and the Chase; he is known as the Huntsman and the Father of Manbeasts. Hircine created the various lycanthropic diseases which transform mortals into beasts, and is, therefore, the father of were-creatures.",
        ...
        "Sheogorath is the infamous Prince of Madness, whose motives are unknowable. His realm in Oblivion is the Shivering Isles, and he is served by the Golden Saints and Dark Seducers. He forms one of the corners of the House of Troubles in Dunmeri theology.",
